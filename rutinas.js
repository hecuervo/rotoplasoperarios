...
function createActividadRutina(id_rutinas_heroku__c, actividadesRutina, callback) {
  for(var i in actividadesRutina) {
    let foto1 = process.env.AZURE_URL + 'rutina'+id_rutinas_heroku__c +'/'+ actividadesRutina[i].foto1__c;
    let foto2 = process.env.AZURE_URL + 'rutina'+id_rutinas_heroku__c +'/'+ actividadesRutina[i].foto2__c;
