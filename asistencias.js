...
function createAsistencia(req, res) {
  ...
  db.query('insert into  ' + dbConfig.schema + '.asistencia__c (tipo__c, usuarioapp__c, geolocalizacion__latitude__s, geolocalizacion__longitude__s, createddate_heroku__c) values( $1, $2, $3, $4, $5 )',
